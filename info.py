...
FORCE_SUB_CHANNELS = [int(fsub_channels) if fsub_channels.startswith("-") else fsub_channels for fsub_channels in environ.get('FORCE_SUB_CHANNELS', '-1002442422204 -1001785093771').split()]
if len(FORCE_SUB_CHANNELS) == 0:
    print('Info - FORCE_SUB_CHANNELS is empty')
    
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002401879443')
...
if len(DATABASE_URL) == 0:
    ...
    exit()
SECOND_DATABASE_URL = environ.get('SECOND_DATABASE_URL', "mongodb+srv://desi:desi@cluster0.ylhef.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/xxxpornrxx')
